          ...
          <div className="flex gap-3 justify-center">
            {type === "confirm" ? (
              <>
                ...
                <button
                  onClick={onConfirm}
                  className={`px-6 py-3 text-sm font-medium text-white rounded-xl transition-all duration-200 ${styles.button} focus:outline-none focus:ring-2 focus:ring-offset-2 shadow-lg`}
                >
                  {confirmText}
                </button>
              </>
              ...
              <button
                onClick={onClose}
                className={`px-8 py-3 text-sm font-medium text-white rounded-xl transition-all duration-200 ${styles.button} focus:outline-none focus:ring-2 focus:ring-offset-2 shadow-lg`}
              >
                OK
              </button>
            )}
